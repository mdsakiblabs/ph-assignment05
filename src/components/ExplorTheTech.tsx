            ...
            <div className="w-200">
              <div className="yourStack-Card-Container bg-[#f8f8f8] rounded py-3 px-2">
                ...
                {selectedStack.length === 0 ? (
                  <div className="flex justify-center items-center p-5 border border-dashed border-gray-400 rounded">
                    <p className="text-gray-400 text-lg">Your Stack is empty</p>
                  </div>
                ) : (
